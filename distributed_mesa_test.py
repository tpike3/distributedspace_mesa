...
class Space_Distribute():
    ...
    def __init__(self, model, step_finish, args = None, split = 0, buffer = 6,\
                 ...
                 recombine_args = None, verbose = False):
    ...
    def distro_geo(self, steps):
        ...
        for mod in range(self.ncpus):
            ...
            #add dictionary for each prcessor to resolve conflicts
            self.resolver_sched[mod_pos] = []
...
class Message:
        ...
        def receive_left_neighbor(self, bus, grid_width, model, buffer_left, step_finish):
        ...
        def receive_right_neighbor(self, bus, grid_width, model, buffer_right, step_finish):
